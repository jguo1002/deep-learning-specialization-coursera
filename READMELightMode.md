...
> C. 
> 
> For the signal to backpropagate without vanishing, we need <img src="https://latex.codecogs.com/png.latex?c^{<t>}"> to be highly dependent on <img src="https://latex.codecogs.com/png.latex?c^{<t-1>}">, meaning <img src="https://latex.codecogs.com/png.latex?\Gamma_u"> close to 0. 
> 
