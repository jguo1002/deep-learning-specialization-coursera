...
>
> <img src="https://render.githubusercontent.com/render/math?math=G">: generated image. <img src="https://render.githubusercontent.com/render/math?math=C">: content image. <img src="https://render.githubusercontent.com/render/math?math=S">: style image. 
>
> <img src="https://render.githubusercontent.com/render/math?math=J_{content}(C,G) = \frac{1}{2} 
\Vert a^{[l](C)} - a^{[l](G)} \Vert^2 ">
> 
> <img src="https://render.githubusercontent.com/render/math?math=J_{style}(S, G)^{[l]} = \frac{1}
