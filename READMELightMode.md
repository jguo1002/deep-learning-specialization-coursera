...
<img src="https://latex.codecogs.com/png.latex?Z^{[l]}"> and <img src="https://latex.codecogs.com/png.latex?A^{[l]}">:
```
num of row: number of units of the next layer
...
><img src="https://latex.codecogs.com/png.latex?v_t = \beta v_{t-1} + (1-\beta) \theta_t">
>
> <img src="https://latex.codecogs.com/png.latex?v^{corrected}_t = \frac{v_t}{1-\beta^t}">
...
> <img src="https://latex.codecogs.com/png.latex?\alpha=e^t\alpha_0"> explodes <img src="https://latex.codecogs.com/png.latex?\alpha"> instead of decaying it
...
> <img src="https://latex.codecogs.com/png.latex?v_{dW^{[l]}} = \beta_1 v_{dW^{[l]}} + (1-\beta_1) \frac{\partial J}{\partial W^{[l]}}">
> 
> <img src="https://latex.codecogs.com/png.latex?v_{dW^{[l]}} ^{correted} = \frac{v_{dW^{[l]}}}{1 - (\beta_1)^t}">
>
> <img src="https://latex.codecogs.com/png.latex?s_{dW^{[l]}} = \beta_2 v_{dW^{[l]}} + (1-\beta_2) (\frac{\partial J}{\partial W^{[l]}}) ^2">
>
> <img src="https://latex.codecogs.com/png.latex?s_{dW^{[l]}} ^{correted} = \frac{s_{dW^{[l]}}}{1 - (\beta_2)^t}">
> 
> <img src="https://latex.codecogs.com/png.latex?W^{[l]} = W^{[l]} - \alpha \frac{v^{corrected}_{dW^{[l]}}}  {\sqrt{s_{dW^{[l]}} ^{correted}} + \varepsilon}">
...
> <img src="https://latex.codecogs.com/png.latex?z_{norm}^{(i)} = \frac{z^{(i) - \mu}}{\sqrt{\sigma^2 + \epsilon}}">
...
**What is the dimension of one grid in YOLO? Suppose there are <img src="https://latex.codecogs.com/png.latex?C"> classes and <img src="https://latex.codecogs.com/png.latex?A"> anchors**
...
>
> <img src="https://latex.codecogs.com/png.latex?\Gamma_u">: updated gate, (0,1)
>
> <img src="https://latex.codecogs.com/png.latex?\Gamma_u = \sigma(W_u[c^{<t-1>}, x^{<t>}] + b_u)"> 
> 
> <img src="https://latex.codecogs.com/png.latex?\Gamma_r">: how relevant <img src="https://latex.codecogs.com/png.latex?c^{<t-1>}"> is to <img src="https://latex.codecogs.com/png.latex?\tilde{c}^{<t>}">. Same update method with <img src="https://latex.codecogs.com/png.latex?\Gamma_u">
>
> 
...
**Sarah proposes to simplify the GRU by always removing the <img src="https://latex.codecogs.com/png.latex?\Gamma_u">. I.e., setting <img src="https://latex.codecogs.com/png.latex?\Gamma_u"> = 0. Ashely proposes to simplify the GRU by removing the <img src="https://latex.codecogs.com/png.latex?\Gamma_r">. I. e., setting <img src="https://latex.codecogs.com/png.latex?\Gamma_r">= 1 always. Which of these models is more likely to work without vanishing gradient problems even when trained on very long input sequences?**

> No. For the signal to backpropagate without vanishing, we need c<t> to be highly dependent on <img src="https://latex.codecogs.com/png.latex?c^{<t-1>}">.
...
**What does <img src="https://latex.codecogs.com/png.latex?\alpha^{<t,t'>}"> denote in attention model?**
...
<details>
 ...
 > We can't replace <img src="https://latex.codecogs.com/png.latex?s^{<t-1>}"> with <img src="https://latex.codecogs.com/png.latex?s^{<t>}"> because <img src="https://latex.codecogs.com/png.latex?s^{<t>}"> depends on <img src="https://latex.codecogs.com/png.latex?\alpha^{<t,t'>}"> which in turn depends on and <img src="https://latex.codecogs.com/png.latex?e^{<t,t'>}">; so at the time we need to evaluate this network, we haven't computed <img src="https://latex.codecogs.com/png.latex?s^{<t>}">.
...
> - `RepeatVector` - copy <img src="https://latex.codecogs.com/png.latex?s^{<t-1>}"> value <img src="https://latex.codecogs.com/png.latex?T_x"> times 
> - `Concatenation` - concatenate <img src="https://latex.codecogs.com/png.latex?s^{<t-1>}"> and <img src="https://latex.codecogs.com/png.latex?a^{<t>}">
> - `Dense` - compute <img src="https://latex.codecogs.com/png.latex?e^{<t,t'>}">
> - `Activation` - compute <img src="https://latex.codecogs.com/png.latex?\alpha^{<t,t'>}"> by softmax 
